            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="edit-profile card-body">
                  ...
                  @endif
                  <form action="{{url('/bnpb/posts/create')}}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                      <div class="col-md-12">
                    ...
                    <button type="submit" class="btn btn-info pull-right" name="status_id" value="0">Archive</button>
                    <button type="submit" class="btn btn-success pull-right" name="status_id" value="1">Publish</button>
                  </form>
                </div>
              </div>
            </div>
