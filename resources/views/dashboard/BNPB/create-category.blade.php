...
@section('title','Ziaga Dashboard - Create Category')
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="edit-profile card-body">
                  ...
                  <form action="{{ url('/bnpb/kategori')}}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                      <div class="col-md-4">
                    ...
                    <button type="submit" class="btn btn-success pull-right" name="status_id" value="1">Tambah</button>
                  </form>
                </div>
              </div>
            </div>
