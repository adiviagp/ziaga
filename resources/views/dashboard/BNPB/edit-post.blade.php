            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="edit-profile card-body">
                  ...
                  <form action="{{url('/bnpb/posts/'.$content -> id.'/update')}}" method="post" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn btn-info pull-right" name="status_id" value="{{$content -> status_id}}">Edit</button>
