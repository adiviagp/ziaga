  ...
  <div class="container">
    <div class="row fullscreen align-items-center justify-content-center">
      <div class="banner-left col-lg-6">
        <img width="80%" height="auto" class="d-flex mx-auto img-fluid" src="{{ asset('/assets/img/natural/'. $kategori -> thumbnail)}}" alt="">
      </div>
      <div class="col-lg-6">
        <div class="story-content">
          <h1 class="sp-1">{{$kategori -> kategori }}</h1><br>
          <p class="description">{{$kategori -> description}}</p>
        </div>
      </div>
    </div>
  </div>
...
<!-- Start ARTIKEL Area -->
<section id="berita">
  <h1 style="font-size:48px;margin-left:20px">Berita {{$kategori -> kategori }}</h1>
