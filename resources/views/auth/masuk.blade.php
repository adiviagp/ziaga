  ...
  <div style="border-radius:12px;padding:40px" class="col-lg-5 card bg-light container">
    <div class="row justify-content-center text-center">
      <div class="single-contact col-lg-6 col-md-8">
        <h2 class="text-dark"><span>LOGIN</span></h2>
        <p class="text-dark">
    ...
    <form action="{{url('/masuk')}}" method="post" class="contact-form text-dark">
        {{csrf_field()}}
      ...
      <div class="col-lg-10 d-flex justify-content-end">
        <button type="submit" class="primary-btn white-bg d-inline-flex align-items-center mt-20"><span class="mr-10">MASUK</span></button> <br>
      </div>
